...
$email_providers = array(
	...
	'salesforce'       => __( 'SalesForce', 'bloom' ),
	'hubspot'          => __( 'HubSpot', 'bloom' ),
);
...
$dashboard_options_all = array(
	...
	'load_in' => array(
		...
		'trigger_click' => array(
			'type'            => 'checkbox',
			'title'           => __( 'Trigger On Click', 'bloom' ),
			'name'            => 'trigger_click',
			'default'         => false,
			'validation_type' => 'boolean',
		...
		'trigger_click_selector' => array(
			...
			'subtype'         => 'text',
			'placeholder'     => '',
			'title'           => __( 'CSS Selector (string)', 'bloom' ),
			'name'            => 'trigger_click_selector',
			'hint_text'       => __( 'A CSS selector string for a trigger element of your choosing. This opt-in will be triggered by clicking the element. Example: a.trigger_popup', 'bloom' ),
			'default'         => '',
			'validation_type' => 'simple_text',
			'display_if'      => 'true',
		),
	...
	'pages_exclude' => array(
		...
		array(
			...
			'placeholder'     => __( 'start typing page name...', 'bloom' ),
			'default'         => '',
			'validation_type' => 'simple_text',
		),
	),
	...
	'posts_exclude' => array(
		...
		array(
			...
			'placeholder'     => __( 'start typing post name...', 'bloom' ),
			'default'         => '',
			'validation_type' => 'simple_text',
		),
	),
